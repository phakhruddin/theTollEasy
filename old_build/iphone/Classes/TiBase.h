...
// in simulator we redefine to format for theTollEasy Developer console
...
{\
	NSString * exceptionName = [@"org.thetolleasy." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.thetolleasy";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UItheTollEasyNativeItemNone = -1, 
	UItheTollEasyNativeItemSpinner = -2,
	UItheTollEasyNativeItemProgressBar = -3,
	
	UItheTollEasyNativeItemSlider = -4,
	UItheTollEasyNativeItemSwitch = -5,
	UItheTollEasyNativeItemMultiButton = -6,
	UItheTollEasyNativeItemSegmented = -7,
	
	UItheTollEasyNativeItemTextView = -8,
	UItheTollEasyNativeItemTextField = -9,
	UItheTollEasyNativeItemSearchBar = -10,
	
	UItheTollEasyNativeItemPicker = -11,
	UItheTollEasyNativeItemDatePicker = -12,
	
	UItheTollEasyNativeItemInfoLight = -13,
	UItheTollEasyNativeItemInfoDark = -14,
	
	UItheTollEasyNativeItemDisclosure = -15,
	
	UItheTollEasyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all theTollEasy instances of
