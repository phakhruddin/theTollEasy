...
/**
 Base class for all theTollEasy views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the theTollEasy view hierarchy (such as wrapped iOS UIViews) was touched.
