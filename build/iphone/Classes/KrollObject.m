...
//@interface theTollEasyObject : NSObject
//@end

@interface theTollEasyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[theTollEasyObject class]])
		{
			for (NSString *key in [[(theTollEasyObject*)o modules] allKeys])
			{
