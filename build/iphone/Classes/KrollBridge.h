...
@interface theTollEasyObject : KrollCoverageObject {
#else
@interface theTollEasyObject : KrollObject {
#endif
@private
...
extern NSString * theTollEasy$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	theTollEasyObject *_thetolleasy;
    KrollObject* console;
	BOOL shutdown;
